...
+/
module wasm_drt.wasip2.sockets.udp.imports;


import wasm_drt.wasip2.wit;

public import wasm_drt.wasip2.sockets.udp.common;
  ...
  struct Borrow {
    ...
    Result!(Tuple!(IncomingDatagramStream, OutgoingDatagramStream), ErrorCode) stream(in Option!(IpSocketAddress) remoteAddress) @trusted @nogc nothrow {
      ...
      if (remoteAddress.isSome) {
        ...
        alias _Tag20 = wasm_drt.wasip2.sockets.network.imports.IpSocketAddress.Tag;
        final switch (_payload3.tag) {
          case _Tag20.ipv4: {
            const ref wasm_drt.wasip2.sockets.network.imports.Ipv4SocketAddress _payload5 = _payload3.getIpv4();
            _variantPart8 = 0;
          ...
          case _Tag20.ipv6: {
            const ref wasm_drt.wasip2.sockets.network.imports.Ipv6SocketAddress _payload7 = _payload3.getIpv6();
            _variantPart8 = 1;
      ...
      Result!(Tuple!(IncomingDatagramStream, OutgoingDatagramStream), ErrorCode) _result39 = void;
      bool _isErr39 = (cast(uint)(*(cast(ubyte*)(_retArea.ptr + 0)))) != 0;
      if (_isErr39) {
        
        _result39 = Result!(Tuple!(IncomingDatagramStream, OutgoingDatagramStream), ErrorCode).makeErr(cast(wasm_drt.wasip2.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 4)))));
      } else {
        auto _handle35 = IncomingDatagramStream(*(cast(uint*)(_retArea.ptr + 4)));
        auto _handle36 = OutgoingDatagramStream(*(cast(uint*)(_retArea.ptr + 8)));
        auto _tuple37 = Tuple!(IncomingDatagramStream, OutgoingDatagramStream)(
        _handle35,
        _handle36,
        );

        _result39 = Result!(Tuple!(IncomingDatagramStream, OutgoingDatagramStream), ErrorCode).makeOk(_tuple37);
      }
      auto _flush40 = _result39;
      return _flush40;
    }
    /// ditto
...
struct IncomingDatagramStream {
  ...
  struct Borrow {
    ...
    Result!(WitList!(IncomingDatagram), ErrorCode) receive(ulong maxResults) @trusted @nogc nothrow {
      ...
      bool _isErr17 = (cast(uint)(*(cast(ubyte*)(_retArea.ptr + 0)))) != 0;
      if (_isErr17) {
        
        _result17 = Result!(WitList!(IncomingDatagram), ErrorCode).makeErr(cast(wasm_drt.wasip2.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + size_t.sizeof)))));
      } else {
        auto _listSrcPtr14 = *(cast(void**)(_retArea.ptr + size_t.sizeof));
        auto _listLen14 = *(cast(size_t*)(_retArea.ptr + (2*size_t.sizeof)));
        auto _list14 = _listLen14 ? wasm_drt.wasip2.wit.mallocSlice!(IncomingDatagram)(_listLen14) : [];
        assert(!_listLen14 || _list14.ptr);
        foreach (_elem1_idx, ref _elem1; _list14) {
          const auto _base1 = _listSrcPtr14 + _elem1_idx * (32+2*size_t.sizeof);
          auto _len2 = *(cast(size_t*)(_base1 + size_t.sizeof));
          auto _ptr2 = _len2 ? cast(ubyte*)(*(cast(void**)(_base1 + 0))) : null;
          auto _list3 = WitList!(ubyte)(_ptr2[0.._len2]);
          wasm_drt.wasip2.sockets.network.imports.IpSocketAddress _variant10 = void;
          auto _tag10 = cast(uint)(*(cast(ubyte*)(_base1 + (2*size_t.sizeof))));
          alias _Tag10 = wasm_drt.wasip2.sockets.network.imports.IpSocketAddress.Tag;
          final switch (cast(wasm_drt.wasip2.sockets.network.imports.IpSocketAddress.Tag)_tag10) {
            case _Tag10.ipv4: {
              auto _tuple5 = wasm_drt.wasip2.sockets.network.imports.Ipv4Address(
              ...
              wasm_drt.wasip2.sockets.network.imports.Ipv4SocketAddress _record6 = {
                port: cast(ushort)(cast(uint)(*(cast(ushort*)(_base1 + (4+2*size_t.sizeof))))),
                address: _tuple5,
              };
              auto _payload11 = _record6;
              _variant10 = wasm_drt.wasip2.sockets.network.imports.IpSocketAddress.ipv4(_payload11);
              break;
            }
            case _Tag10.ipv6: {
              auto _tuple8 = wasm_drt.wasip2.sockets.network.imports.Ipv6Address(
              ...
              wasm_drt.wasip2.sockets.network.imports.Ipv6SocketAddress _record9 = {
                port: cast(ushort)(cast(uint)(*(cast(ushort*)(_base1 + (4+2*size_t.sizeof))))),
                flowInfo: *(cast(uint*)(_base1 + (8+2*size_t.sizeof))),
                address: _tuple8,
                scopeId: *(cast(uint*)(_base1 + (28+2*size_t.sizeof))),
              };
              auto _payload12 = _record9;
              _variant10 = wasm_drt.wasip2.sockets.network.imports.IpSocketAddress.ipv6(_payload12);
              break;
            }
          }
          IncomingDatagram _record13 = {
            data: _list3,
            remoteAddress: _variant10,
          };
          _elem1 = _record13;
        }
        if (_listLen14) wasm_drt.wasip2.wit.free(_listSrcPtr14);
        auto _witList15 = WitList!(IncomingDatagram)(_list14);

        _result17 = Result!(WitList!(IncomingDatagram), ErrorCode).makeOk(_witList15);
      }
      auto _flush18 = _result17;
      return _flush18;
    }
    /// ditto
...
struct OutgoingDatagramStream {
  ...
  struct Borrow {
    ...
    Result!(ulong, ErrorCode) send(in WitList!(OutgoingDatagram) datagrams) @trusted @nogc nothrow {
      ...
      auto _list10 = _listSrc10.length ? wasm_drt.wasip2.wit.malloc(_listSrc10.length * ((32+3*size_t.sizeof))) : null;
      assert(!_listSrc10.length || _list10);
      if (_listSrc10.length) deallocate ~= _list10;
      foreach (_elem0_idx, ref _elem0; _listSrc10) {
        ...
        *cast(void**)(_base0 + 0) = cast(void*)(cast(void*)(_elem0.data.ptr));
        if (_elem0.remoteAddress.isSome) {
          ...
          *cast(ubyte*)(_base0 + (2*size_t.sizeof)) = cast(ubyte)(1);
          alias _Tag9 = wasm_drt.wasip2.sockets.network.imports.IpSocketAddress.Tag;
          final switch (_payload4.tag) {
            case _Tag9.ipv4: {
              const ref wasm_drt.wasip2.sockets.network.imports.Ipv4SocketAddress _payload6 = _payload4.getIpv4();
            ...
            case _Tag9.ipv6: {
              const ref wasm_drt.wasip2.sockets.network.imports.Ipv6SocketAddress _payload8 = _payload4.getIpv6();
      ...
      if (_isErr13) {
        ...
        _result13 = Result!(ulong, ErrorCode).makeErr(cast(wasm_drt.wasip2.sockets.network.imports.ErrorCode)(cast(uint)(*(cast(ubyte*)(_retArea.ptr + 8)))));
      } else {
        
        _result13 = Result!(ulong, ErrorCode).makeOk(*(cast(ulong*)(_retArea.ptr + 8)));
      }
