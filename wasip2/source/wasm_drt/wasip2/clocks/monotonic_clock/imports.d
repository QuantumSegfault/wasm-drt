...
private extern(C) ulong __import_now() nothrow;

/++

+/
Duration resolution() @trusted nothrow {
...
private extern(C) ulong __import_resolution() nothrow;

/++

+/
Pollable subscribeInstant(Instant when) @trusted nothrow {
...
private extern(C) uint __import_subscribeInstant(ulong) nothrow;

/++

+/
Pollable subscribeDuration(Duration when) @trusted nothrow {
...
private extern(C) uint __import_subscribeDuration(ulong) nothrow;
